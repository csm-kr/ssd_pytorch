...
def get_args_parser():
    ...
    parser.add_argument('--thres', type=float, default=0.01, help='score threshold - 0.05 for test 0.5 for demo')
    parser.add_argument('--top_k', type=int, default=300, help='set top k for after nms')
